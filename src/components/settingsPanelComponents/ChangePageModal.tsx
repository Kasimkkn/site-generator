        ...
        <div>
            ...
            <div className="grid grid-cols-2 gap-3">
                {Object.keys(openDifferentPages).map((page) => (
                    <button
                        key={page}
                        className={`px-4 py-3 text-center font-black uppercase tracking-wide transition-all duration-200 transform hover:scale-105 border-2 ${
                            openDifferentPages[page as keyof typeof openDifferentPages] 
