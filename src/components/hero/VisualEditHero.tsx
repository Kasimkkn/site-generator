...
interface VisualEditHeroProps {
  data?: HeroData;
}

const VisualEditHero: React.FC<VisualEditHeroProps> = ({ data }) => {
  if (!data) return null;

  const titleWords = data.heroTitle?.split(' ') || ['BUILD', 'BRUTAL', 'WEBSITES'];
          ...
          >
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight">
                ...
                <span className="block text-lime-400">{restWords}</span>
              </h1>
            </EditableElement>
