...
export const ThemeSelector: React.FC = () => {
    ...
    return (
        <motion.div 
            ...
            className="max-w-[400px] p-6 bg-black border-4 border-lime-400 transform -rotate-1"
        >
            ...
            <button
                onClick={handleSave}
                className="w-full px-6 py-4 bg-lime-400 text-black font-black text-lg uppercase tracking-wide hover:bg-pink-500 hover:text-white transform hover:scale-105 hover:rotate-1 transition-all duration-300 border-4 border-lime-400 hover:border-pink-500"
            >
                APPLY REBELLION
            </button>
        </motion.div>
